...
{
	public sealed class StructureMapWiringHtmlReporter : IStructureMapWiringReporter
	{
		public void WriteWirings(IEnumerable<StructureMapWiringCtx> items, string header = null)
		{
